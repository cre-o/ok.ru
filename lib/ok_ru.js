...
(function() {
  ...
  OkApi = (function() {
    var makeRequest, okSignature, parametrize, parseObjectsToString, validateOptions;
    ...
    parseObjectsToString = function(data) {
      var key, newData, value;
      newData = {};
      for (key in data) {
        value = data[key];
    ...
    parametrize = function(obj, join) {
      ...
      _.each(arrayOfArrays, function(value) {
        if (typeof _.last(value) === 'object') {
          return sortedParams += ("" + (_.first(value)) + "=" + (JSON.stringify(_.last(value)))) + symbol;
        } else {
